...
### Requirement: Player Stats — Success Rate Trend Chart
**Reason**: Aggregate success % across all actions is not informative; player page visualization deferred to a future iteration.
**Migration**: No data migration; chart UI and Chart.js dependency removed from player profile page.
