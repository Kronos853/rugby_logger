...
**Последнее обновление:** 2026-07-06 (phase2-reports: отчёты, статистика игрока, ShowInReport, PeriodCount)
...
| `/reports` | Отчёты (командные/индивидуальные, период, турнир, разрез по матчам) |
...
- `/reports` — встроенная отчётность, фильтр по турниру и периоду
