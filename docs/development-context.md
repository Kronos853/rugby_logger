...
**Последнее обновление:** 2026-07-07 (tagging-current-draft: блок «ТЕКУЩЕЕ СОБЫТИЕ» + ряд «Последние» действий)
...
- Пульт разметки: липкий блок **«ТЕКУЩЕЕ СОБЫТИЕ»** (режим НОВОЕ/РЕДАКТИРОВАНИЕ, чипы Игрок→Действие→Результат, тайм)
